...
- **Email 2 should be a question, not a pitch** — "Did something get in the way?" generates replies that diagnose your onboarding failures
- **Magic link** (one-click login, no password) in recovery emails lifts activation for users who forgot credentials or couldn't be bothered to reset
...
Log in and do it now: {{magic_link}}

Takes about 5 minutes. After that, {{value_statement}}.

---
Subject (Day 3): Did something get in the way?
You signed up for {{product}} but haven't logged in — is something blocking you?
